...
# importing models
from App.models import User,Restaurant,Photos
...
def register():
	...
	if form.validate_on_submit():
		...
		user = User(username=form.username.data, email=form.email.data, password=hashed_password, photo=form.photo.data)
		db.session.add(user)
		db.session.commit()

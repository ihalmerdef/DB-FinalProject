...
choices = list()
listOfEmployees = Employee.query.all()
for employee in listOfEmployees:
    fullName = employee.fname + " " + employee.lname
    choices.append((employee.ssn, fullName))


class AddEmployeeToProjectForm(FlaskForm):
    employees = SelectField("Employee", choices = choices )
